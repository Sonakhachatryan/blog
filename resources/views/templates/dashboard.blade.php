                        ...
                        <div class="col-md-3 praesent">
                            <div class="l_g_r">
                                <div class="dapibus">
                                    <h3>CURSUS FAUCIO</h3>
                                    <p class="adm">Posted by <a href="#">Admin</a>  |  7 days ago</p>
                                    <a href="details.html"><img src=" {{ url('images/test/images/img2.jpg') }}" class="img-responsive" alt=""></a>
                        ...
                        <div class="col-md-3 praesent">
                            <div class="l_g_r">
                                <div class="dapibus">
                                    <h2>Praesent dapibusneque id cursus faucioibus tortor neque tiegetas augue</h2>
                                    <p class="adm">Posted by <a href="#">Admin</a>  |  7 days ago</p>
                                    <a href="details.html"><img src=" {{ url('images/test/images/img10.jpg') }}" class="img-responsive" alt=""></a>
                                    <p>Phasellus ultrices nulla quis nibh. Quisque a lectus. Donec consectetuer ligula vulputate. </p>
                                    <a href="details.html" class="link">Read More</a>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3 integ">
                            <div class="l_g_r">
                                <div class="vitae">
                                    <h3>Integer vitae libero risus egestas</h3>
                                    <p class="adm">Posted by <a href="#">Admin</a>  |  7 days ago</p>
                                    <a href="details.html"><img src=" {{ url('images/test/images/img4.jpg') }}" class="img-responsive" alt=""></a>
                        ...
                        <div class="col-md-3 praesent">
                            <div class="l_g_r">
                                <div class="integer">
                                    ...
                                    <p class="adm">Posted by <a href="#">Admin</a>  |  7 days ago</p>
                                    <a href="details.html"><img src=" {{ url('images/test/images/img11.jpg') }}" class="img-responsive" alt=""></a>
                                    <p>Phasellus ultrices nulla quis nibh. Quisque a lectus. Donec consectetuer ligula vulputate. </p>
                                    <a href="details.html" class="link">Read More</a>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3 praesent">
                            <div class="l_g_r">
                                <div class="dapibus">
                                    <h2>Praesent dapibusneque id cursus faucioibus tortor neque tiegetas augue</h2>
                                    <p class="adm">Posted by <a href="#">Admin</a>  |  7 days ago</p>
                                    <a href="details.html"><img src=" {{ url('images/test/images/img13.jpg') }}" class="img-responsive" alt=""></a>
                                    <p>Phasellus ultrices nulla quis nibh. Quisque a lectus. Donec consectetuer ligula vulputate. </p>
                                    <a href="details.html" class="link">Read More</a>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3 integ">
                            <div class="l_g_r">
                                <div class="vitae">
                                    <h3>Integer vitae libero risus egestas</h3>
                                    <p class="adm">Posted by <a href="#">Admin</a>  |  7 days ago</p>
                                    <a href="details.html"><img src=" {{ url('images/test/images/img14.jpg') }}" class="img-responsive" alt=""></a>
                                    <p>Sed adipiscing ornare risus. Morbi est est, blandit sit amet</p>
                                    <a href="details.html" class="link">Read More</a>
                                </div>
                        ...
                        <div class="col-md-3 praesent">
                            <div class="l_g_r">
                                <div class="integer">
                                    <h3>Praesent dapibusn id cursus</h3>
                                    <p class="adm">Posted by <a href="#">Admin</a>  |  7 days ago</p>
                                    <a href="details.html"><img src=" {{ url('images/test/images/img15.jpg') }}" class="img-responsive" alt=""></a>
                                    <p>Phasellus ultrices nulla quis nibh. Quisque a lectus. Donec consectetuer ligula vulputate. </p>
                                    <a href="details.html" class="link">Read More</a>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3 praesent">
                            <div class="l_g_r">
                                <div class="dapibus">
                                    <h2>Praesent dapibusneque id cursus faucioibus tortor neque tiegetas augue</h2>
                                    <p class="adm">Posted by <a href="#">Admin</a>  |  7 days ago</p>
                                    <a href="details.html"><img src=" {{ url('images/test/images/img16.jpg') }}" class="img-responsive" alt=""></a>
                                    <p>Phasellus ultrices nulla quis nibh. Quisque a lectus. Donec consectetuer ligula vulputate. </p>
                                    <a href="details.html" class="link">Read More</a>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3 integ">
                            <div class="l_g_r">
                                <div class="vitae">
                                    <h3>Integer vitae libero risus egestas</h3>
                                    <p class="adm">Posted by <a href="#">Admin</a>  |  7 days ago</p>
                                    <a href="details.html"><img src=" {{ url('images/test/images/img17.jpg') }}" class="img-responsive" alt=""></a>
                                    <p>Sed adipiscing ornare risus. Morbi est est, blandit sit amet</p>
                                    <a href="details.html" class="link">Read More</a>
                                </div>
                        ...
                        <div class="col-md-3 praesent">
                            <div class="l_g_r">
                                <div class="integer">
                                    <h3>Praesent dapibusn id cursus</h3>
                                    <p class="adm">Posted by <a href="#">Admin</a>  |  7 days ago</p>
                                    <a href="details.html"><img src="{{ url('images/test/images/img5.jpg') }}" class="img-responsive" alt=""></a>
                                    <p>Phasellus ultrices nulla quis nibh. Quisque a lectus. Donec consectetuer ligula vulputate. </p>
                                    <a href="details.html" class="link">Read More</a>
                                </div>
                            </div>
